...
class Ball:
    """
    The ball class. Creates a ball, controls it's movement and implement it's
    rendering.
    """
...
class Gun:
    ...
    def __init__(self, coord=[30, SCREEN_SIZE[1] // 2], angle=0, max_pow=70,
                 min_pow=10, color=RED):
        """
        Constructor method. Sets coordinate, direction, minimum and maximum
        power and color of the gun.
        """
        self.coord = coord
        self.angle = angle
